    ...
    (function(H) {
        ...
        Navigator.prototype = {
            ...
            renderElements: function() {
                ...
                // Create the webapp navigator group
            ...
            /**
             * Add data events.
             * For example when webapp series is updated we need to recalculate extremes
             */
    ...
    (function(H) {
        ...
        H.StockChart = H.stockChart = function(a, b, c) {
            var hasRenderToArg = isString(a) || a.nodeName,
                ...
                // Always disable startOnTick:true on the webapp axis when the navigator
                // is enabled (#1090)
