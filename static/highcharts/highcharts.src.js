    ...
    (function(H) {
        ...
        SVGElement.prototype = {
            ...
            init: function(renderer, nodeName) {
                ...
                /** 
                 * The DOM node. Each SVGRenderer instance wraps a webapp DOM node, but
                ...
                if (typeof hash === 'string') {
                    ...
                    objectEach(hash, function(val, key) {
                        ...
                        if (!skipAttr) {
                            ...
                            // Let the shadow follow the webapp element
        ...
        seriesType('area', 'line', {
            ...
            drawGraph: function() {
                ...
                var series = this,
                    ...
                    ]; // area name, webapp color, fill color
        ...
        seriesType('spline', 'line', {}, /** @lends seriesTypes.spline.prototype */ {
            ...
            getPointSpline: function(points, point, i) {
                ...
                if (doCurve(lastPoint) && doCurve(nextPoint)) {
                    ...
                    // Have the two control points make a straight line through webapp point
